    ...
    <div class="vx-navbar-wrapper navbar-full p-0">
      ...
      >
        ...
        <router-link tag="div" to="/" class="vx-logo cursor-pointer mx-auto flex items-center">
          ...
          <span class="vx-logo-text">Tales Of Threa</span>
        </router-link>
        ...
        <div class="the-navbar__user-meta flex items-center">
          <div class="text-right leading-tight hidden sm:block">
            <p class="font-semibold">{{ "Antoine MILOUX" }}</p>
...
export default {
  ...
  computed: {
    ...
    activeUserImg() {
      return "https://i.pinimg.com/564x/f3/f6/e3/f3f6e3084e59defbc4067252b34a04b0.jpg";
    }
  },
  methods: {
    updateLocale(locale) {
